...
const CreateNewNote = ({ handleBackToList }) => {
  ...
  return (
    <form onSubmit={handleSubmit(_onsubmit)}>
      <div className="flex items-center justify-between w-full lg:hidden cursor-pointer">
        <div className="flex items-center gap-1">
          <MdKeyboardArrowLeft className="text-secondary w-6 h-6" />
          <span
            onClick={() => handleBackToList()}
            className="text-secondary font-normal text-sm tracking-[130%] leading-[-0.2px]"
          >
            Back
          </span>
        </div>
        <div className="flex items-center justify-center gap-4">
          <RiDeleteBin5Line className="text-secondary w-5 h-5" />
          <IoArchiveOutline className="text-secondary w-5 h-5" />
          <span className="text-secondary font-normal text-sm tracking-[130%] leading-[-0.2px]">
            Cancel
          </span>
          <span
            className="text-accent font-normal text-sm tracking-[130%] leading-[-0.2px]"
            onClick={() => _onsubmit()}
          >
            Save Note
          </span>
  ...
  font-bold text-2xl leading-[-0.5px] tracking-[120%]
  focus:border-accent focus:rounded-sm focus:ring-0 transition-all duration-200 bg-transparent"
        type="text"
        name="title"
        id="name"
        {...register("title", {
      ...
      <div className="flex flex-col gap-6 my-2 text-secondary border-b border-dark pb-8">
        <div className="flex items-center sm:gap-x-5 ">
          ...
          >
            ...
            <input
              ...
              className="border-none outline-none bg-transparent text-secondary"
        ...
        {errors.tags && (
          <div className="flex text-[#df3b3b] items-center -mt-5 font-normal text-sm gap-2">
            <CiCircleInfo className="w-6 h-6 text-[#df3b3b]" />
            {errors.tags.message}
          </div>
        )}
  ...
  focus:border-accent focus:ring-0 focus:rounded-sm transition-all duration-200"
        ></textarea>
        {errors.content && (
          <div className="flex text-[#df3b3b] items-center mt-2 font-normal text-sm gap-2">
            <CiCircleInfo className="w-6 h-6 text-[#df3b3b]" />
      ...
      <div className="hidden lg:flex lg:items-center lg:gap-4 lg:pt-4">
        <button
          className={`bg-accent text-white rounded-lg px-4 py-3 font-medium text-sm tracking-[120%] leading-[-0.2px]  ${
