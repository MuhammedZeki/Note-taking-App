  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-primary font-inter font-semibold text-[1rem] tracking-[120%] leading-[-0.3px]">
          Font Theme
        </p>
        <p className="text-secondary font-inter font-normal text-sm tracking-[130%] leading-[-0.2px]">
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-primary font-inter font-medium text-sm tracking-[120%] leading-[-0.2px]">
                Sans-serif
              </span>
              <span className="text-secondary font-inter font-normal text-xs tracking-[120%] leading-[-0.2px]">
        ...
        <div className="flex items-center justify-start">
          <button className="px-4 py-3 cursor-pointer rounded-lg bg-accent text-white">
            Apply Changes
          </button>
        </div>
      </div>
